...
# Disable caching so BACK BUTTON does not load dashboard again
@app.after_request
...
def dashboard():
    ...
    if video_id:
        API_KEY = "AIzaSyBmIrh5B1czpO2YGlxlA9V28bwpZ0_wbSA"
        ...
        # Gemini summary
        genai.configure(api_key="AIzaSyB_VOh5ENzwpbVXZZ7lhPlv6mMqEAZnc9w")
        ...
        STRICT RULES:
        - Each field must be a single STRING containing EXACTLY TWO LINES.
        - DO NOT return a JSON array. DO NOT use brackets [].
        - DO NOT add bullet points or emojis.
        - DO NOT exceed 2 lines.
        - Each line must be short (max 12 words).
